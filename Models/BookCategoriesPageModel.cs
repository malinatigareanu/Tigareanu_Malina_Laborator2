...
namespace Tigareanu_Malina_Laborator2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Tigareanu_Malina_Laborator2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Tigareanu_Malina_Laborator2Context context,
